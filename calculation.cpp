...
MonthDividendDataType Calculation::getMonthDividendData(const QDate &from, const QDate &to)
{
    Q_ASSERT(stockData);
    Q_ASSERT(database);

    //    year              month  price
    MonthDividendDataType dividends;
...
{
    MonthDividendDataType dividends = getMonthDividendData(from, to);
